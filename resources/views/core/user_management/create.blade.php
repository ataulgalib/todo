...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <form action="{{ route('core.user.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="box-body col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control" id="password"
                            placeholder="{{ __('Application Defult Password is '.config('configuration.application_defult_password')) }}"
                            value="{{ old('password', config('configuration.application_defult_password') ) }}">
                        @error('password')
                        <span class="error-text">{{ $message }}</span>
                        @enderror
                    </div>
